...
// Generated by scripts/fetch-token-icons.mjs: mint → "/token-icons/<file>".
// Mints missing from the manifest (e.g. newly added token before the next
...
for (const entry of Object.values(data)) {
  for (const s of entry.stablecoins) {
    const local = ICON_OVERRIDES[s.mint];
