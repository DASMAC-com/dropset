...
// from committed bytes with no network access, so this mapping cannot be
// thinned by a third-party host being down at build time — the case the
// fallback below was originally load-bearing for.
