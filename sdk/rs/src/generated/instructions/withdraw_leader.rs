...
pub const WITHDRAW_LEADER_DISCRIMINATOR: [u8; 1] = [11];
...
impl WithdrawLeader {
  pub fn instruction(&self, args: WithdrawLeaderInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: WithdrawLeaderInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = WithdrawLeaderInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct WithdrawLeaderInstructionData {
            discriminator: [u8; 1],
                              }

impl WithdrawLeaderInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [11],
                                                                          }
...
impl Default for WithdrawLeaderInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct WithdrawLeaderInstructionArgs {
                  pub vault_idx: u32,
                pub shares_in: u64,
...
impl WithdrawLeaderInstructionArgs {
  pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
    borsh::to_vec(self)
  }
}
...
/// Instruction builder for `WithdrawLeader`.
///
/// ### Accounts:
///
...
pub struct WithdrawLeaderBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = WithdrawLeader {
          ...
          let args = WithdrawLeaderInstructionArgs {
  ...
  /// `withdraw_leader` CPI accounts.
  pub struct WithdrawLeaderCpiAccounts<'a, 'b> {
                  /// Must equal `vault.leader` — verified in-handler.
...
/// `withdraw_leader` CPI instruction.
pub struct WithdrawLeaderCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: WithdrawLeaderInstructionArgs,
  }

impl<'a, 'b> WithdrawLeaderCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: WithdrawLeaderCpiAccounts<'a, 'b>,
              args: WithdrawLeaderInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `WithdrawLeader` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
          ...
          ///   13. `[]` program
#[derive(Clone, Debug)]
pub struct WithdrawLeaderCpiBuilder<'a, 'b> {
  instruction: Box<WithdrawLeaderCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawLeaderCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(WithdrawLeaderCpiBuilderInstruction {
      __program: program,
              signer: None,
              market: None,
              base_mint: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = WithdrawLeaderCpi {
...
#[derive(Clone, Debug)]
struct WithdrawLeaderCpiBuilderInstruction<'a, 'b> {
