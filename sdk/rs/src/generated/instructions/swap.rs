    ...
    let accounts = Swap {
          ...
          let args = SwapInstructionArgs {
                                                              side: self.side.clone().expect("side is not set"),
                                                                  ...
                                                                  limit_price_bits: self.limit_price_bits.clone().expect("limit_price_bits is not set"),
...
#[inline(always)]
    ...
    pub fn quote_token_program(&mut self, quote_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn taker_base_ata(&mut self, taker_base_ata: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.taker_base_ata = Some(taker_base_ata);
                    self
    }
      #[inline(always)]
    pub fn taker_quote_ata(&mut self, taker_quote_ata: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = SwapInstructionArgs {
                                                              side: self.instruction.side.clone().expect("side is not set"),
                                                                  ...
                                                                  limit_price_bits: self.instruction.limit_price_bits.clone().expect("limit_price_bits is not set"),
                                                                  min_out: self.instruction.min_out.clone().expect("min_out is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          taker_base_ata: self.instruction.taker_base_ata.expect("taker_base_ata is not set"),
                  
          taker_quote_ata: self.instruction.taker_quote_ata.expect("taker_quote_ata is not set"),
