...
impl FreezeVault {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: FreezeVaultInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
