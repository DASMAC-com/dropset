...
impl ForceWithdrawLeader {
  pub fn instruction(&self, args: ForceWithdrawLeaderInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ForceWithdrawLeaderInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = ForceWithdrawLeaderInstructionData::new().try_to_vec().unwrap();
...
#[inline(always)]
    ...
    pub fn quote_token_program(&mut self, quote_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Leader's base payout ATA — created (admin-funded) if absent.
#[inline(always)]
    pub fn leader_base_ata(&mut self, leader_base_ata: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.leader_base_ata = Some(leader_base_ata);
                    self
    }
      /// Leader's quote payout ATA — created (admin-funded) if absent.
#[inline(always)]
    pub fn leader_quote_ata(&mut self, leader_quote_ata: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          leader_base_ata: self.instruction.leader_base_ata.expect("leader_base_ata is not set"),
                  
          leader_quote_ata: self.instruction.leader_quote_ata.expect("leader_quote_ata is not set"),
