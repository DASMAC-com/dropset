...
pub const SET_MIN_LEADER_SHARE_DISCRIMINATOR: [u8; 1] = [22];
...
impl SetMinLeaderShare {
    pub fn instruction(
        &self,
        args: SetMinLeaderShareInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = SetMinLeaderShareInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct SetMinLeaderShareInstructionData {
    discriminator: [u8; 1],
}

impl SetMinLeaderShareInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [22],
        }
...
impl Default for SetMinLeaderShareInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SetMinLeaderShareInstructionArgs {
    pub vault_idx: u32,
    pub min_leader_share: u32,
}

impl SetMinLeaderShareInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `SetMinLeaderShare`.
///
/// ### Accounts:
///
///   0. `[signer]` admin
...
pub struct SetMinLeaderShareBuilder {
...
impl SetMinLeaderShareBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = SetMinLeaderShare {
        ...
        let args = SetMinLeaderShareInstructionArgs {
            vault_idx: self.vault_idx.clone().expect("vault_idx is not set"),
            min_leader_share: self
                .min_leader_share
                .clone()
                .expect("min_leader_share is not set"),
        };
...
/// `set_min_leader_share` CPI accounts.
pub struct SetMinLeaderShareCpiAccounts<'a, 'b> {
    /// Registry admin — the only signer this lever accepts.
...
/// `set_min_leader_share` CPI instruction.
pub struct SetMinLeaderShareCpi<'a, 'b> {
    ...
    pub __args: SetMinLeaderShareInstructionArgs,
}

impl<'a, 'b> SetMinLeaderShareCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SetMinLeaderShareCpiAccounts<'a, 'b>,
        args: SetMinLeaderShareInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetMinLeaderShare` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` admin
...
///   4. `[]` program
#[derive(Clone, Debug)]
pub struct SetMinLeaderShareCpiBuilder<'a, 'b> {
    instruction: Box<SetMinLeaderShareCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetMinLeaderShareCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetMinLeaderShareCpiBuilderInstruction {
            __program: program,
            admin: None,
            registry: None,
            market: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = SetMinLeaderShareCpi {
...
#[derive(Clone, Debug)]
struct SetMinLeaderShareCpiBuilderInstruction<'a, 'b> {
