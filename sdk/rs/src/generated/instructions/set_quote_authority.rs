...
pub const SET_QUOTE_AUTHORITY_DISCRIMINATOR: [u8; 1] = [27];
...
impl SetQuoteAuthority {
    pub fn instruction(
        &self,
        args: SetQuoteAuthorityInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = SetQuoteAuthorityInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct SetQuoteAuthorityInstructionData {
    discriminator: [u8; 1],
}

impl SetQuoteAuthorityInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [27],
        }
...
impl Default for SetQuoteAuthorityInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SetQuoteAuthorityInstructionArgs {
    pub vault_idx: u32,
    pub new_authority: Pubkey,
}

impl SetQuoteAuthorityInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `SetQuoteAuthority`.
///
/// ### Accounts:
///
///   0. `[signer]` signer
...
pub struct SetQuoteAuthorityBuilder {
...
impl SetQuoteAuthorityBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = SetQuoteAuthority {
            signer: self.signer.expect("signer is not set"),
            market: self.market.expect("market is not set"),
        };
        let args = SetQuoteAuthorityInstructionArgs {
...
/// `set_quote_authority` CPI accounts.
pub struct SetQuoteAuthorityCpiAccounts<'a, 'b> {
    /// The vault's leader — the only signer this rotation accepts.
...
/// `set_quote_authority` CPI instruction.
pub struct SetQuoteAuthorityCpi<'a, 'b> {
    ...
    pub __args: SetQuoteAuthorityInstructionArgs,
}

impl<'a, 'b> SetQuoteAuthorityCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SetQuoteAuthorityCpiAccounts<'a, 'b>,
        args: SetQuoteAuthorityInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetQuoteAuthority` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` signer
///   1. `[writable]` market
#[derive(Clone, Debug)]
pub struct SetQuoteAuthorityCpiBuilder<'a, 'b> {
    instruction: Box<SetQuoteAuthorityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetQuoteAuthorityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetQuoteAuthorityCpiBuilderInstruction {
            __program: program,
            signer: None,
            market: None,
            vault_idx: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = SetQuoteAuthorityCpi {
...
#[derive(Clone, Debug)]
struct SetQuoteAuthorityCpiBuilderInstruction<'a, 'b> {
