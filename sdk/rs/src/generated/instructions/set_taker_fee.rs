...
pub const SET_TAKER_FEE_DISCRIMINATOR: [u8; 1] = [24];
...
impl SetTakerFee {
    pub fn instruction(&self, args: SetTakerFeeInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        &self,
        args: SetTakerFeeInstructionArgs,
        ...
        let mut data = SetTakerFeeInstructionData::new().try_to_vec().unwrap();
...
pub struct SetTakerFeeInstructionData {
    discriminator: [u8; 1],
}

impl SetTakerFeeInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [24],
        }
...
impl Default for SetTakerFeeInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SetTakerFeeInstructionArgs {
    pub taker_fee: u16,
}

impl SetTakerFeeInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `SetTakerFee`.
///
/// ### Accounts:
///
///   0. `[signer]` admin
...
impl SetTakerFeeBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = SetTakerFeeInstructionArgs {
...
/// `set_taker_fee` CPI accounts.
pub struct SetTakerFeeCpiAccounts<'a, 'b> {
    /// Registry admin — the only signer this lever accepts.
...
/// `set_taker_fee` CPI instruction.
pub struct SetTakerFeeCpi<'a, 'b> {
    ...
    pub __args: SetTakerFeeInstructionArgs,
}

impl<'a, 'b> SetTakerFeeCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SetTakerFeeCpiAccounts<'a, 'b>,
        args: SetTakerFeeInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetTakerFee` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` admin
...
///   4. `[]` program
#[derive(Clone, Debug)]
pub struct SetTakerFeeCpiBuilder<'a, 'b> {
    instruction: Box<SetTakerFeeCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetTakerFeeCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetTakerFeeCpiBuilderInstruction {
            __program: program,
            admin: None,
            registry: None,
            market: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = SetTakerFeeCpi {
...
#[derive(Clone, Debug)]
struct SetTakerFeeCpiBuilderInstruction<'a, 'b> {
