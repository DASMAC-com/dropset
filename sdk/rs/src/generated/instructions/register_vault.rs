...
impl RegisterVault {
  pub fn instruction(&self, args: RegisterVaultInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RegisterVaultInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = RegisterVault {
                              payer: self.payer.expect("payer is not set"),
                                        ...
                                        fee_mint: self.fee_mint.unwrap_or(solana_pubkey::pubkey!("market.fee_config.mint")),
                                        fee_token_program: self.fee_token_program.unwrap_or(solana_pubkey::pubkey!("market.fee_config.token_program")),
          ...
          let args = RegisterVaultInstructionArgs {
                                                              perf_fee_rate: self.perf_fee_rate.clone().expect("perf_fee_rate is not set"),
                                                                  quote_authority: self.quote_authority.clone().expect("quote_authority is not set"),
                                                                  allow_outside_depositors: self.allow_outside_depositors.clone().expect("allow_outside_depositors is not set"),
                                                                  leader_override: self.leader_override.clone().expect("leader_override is not set"),
                                    };
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
          let args = RegisterVaultInstructionArgs {
                                                              perf_fee_rate: self.instruction.perf_fee_rate.clone().expect("perf_fee_rate is not set"),
                                                                  quote_authority: self.instruction.quote_authority.clone().expect("quote_authority is not set"),
                                                                  allow_outside_depositors: self.instruction.allow_outside_depositors.clone().expect("allow_outside_depositors is not set"),
                                                                  leader_override: self.instruction.leader_override.clone().expect("leader_override is not set"),
                                    };
