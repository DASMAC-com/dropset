...
impl ForceWithdrawDepositor {
  pub fn instruction(&self, args: ForceWithdrawDepositorInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ForceWithdrawDepositorInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = ForceWithdrawDepositorInstructionData::new().try_to_vec().unwrap();
...
#[inline(always)]
    ...
    pub fn quote_token_program(&mut self, quote_token_program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// Depositor's base payout ATA — created (admin-funded) if absent.
#[inline(always)]
    pub fn owner_base_ata(&mut self, owner_base_ata: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.owner_base_ata = Some(owner_base_ata);
                    self
    }
      /// Depositor's quote payout ATA — created (admin-funded) if absent.
#[inline(always)]
    pub fn owner_quote_ata(&mut self, owner_quote_ata: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          owner_base_ata: self.instruction.owner_base_ata.expect("owner_base_ata is not set"),
                  
          owner_quote_ata: self.instruction.owner_quote_ata.expect("owner_quote_ata is not set"),
