...
export const simulate_swap: (a: number, b: number, c: number, d: bigint, e: number, f: number, g: number) => [number, number, number];
export const price_base_for_quote: (a: number, b: bigint) => bigint;
export const price_decode: (a: number) => number;
export const price_encode: (a: number) => number;
export const price_is_valid: (a: number) => number;
export const price_quote_for_base: (a: number, b: bigint) => bigint;
